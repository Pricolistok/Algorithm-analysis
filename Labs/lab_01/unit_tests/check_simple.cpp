...
Suite* simple(void)
{
    ...
    tcase_add_test(tc, test_simple_multiplication_with_simple_matrix_with_negatives);
    tcase_add_test(tc, test_simple_multiplication_with_simple_matrix_with_all_negatives);
